...
const Navbar = () => {
  ...
  return (
    <nav className={scrolling ? 'navbar-scroll max-container padding-container flex justify-between py-2 fixed z-50 backdrop-blur-sm bg-transparent' : 'max-container padding-container flex justify-between py-8'}>
        <div className='left'>
